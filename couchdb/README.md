...
```console
$ docker run -d -v $(pwd):/opt/couchdb/data --name my-couchdb i386/couchdb
```
...
```console
$ docker run --name my-couchdb -v /my/custom-config-dir:/opt/couchdb/etc/local.d -d i386/couchdb
```
