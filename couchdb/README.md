...
```console
$ docker run -d -v $(pwd):/opt/couchdb/data --name my-couchdb s390x/couchdb
```
...
```console
$ docker run --name my-couchdb -v /my/custom-config-dir:/opt/couchdb/etc/local.d -d s390x/couchdb
```
