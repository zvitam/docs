...
```console
$ docker run -d -v $(pwd):/opt/couchdb/data --name my-couchdb arm64v8/couchdb
```
...
```console
$ docker run --name my-couchdb -v /my/custom-config-dir:/opt/couchdb/etc/local.d -d arm64v8/couchdb
```
