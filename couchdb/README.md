...
```console
$ docker run -d -v $(pwd):/opt/couchdb/data --name my-couchdb arm32v7/couchdb
```
...
```console
$ docker run --name my-couchdb -v /my/custom-config-dir:/opt/couchdb/etc/local.d -d arm32v7/couchdb
```
