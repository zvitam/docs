...
```console
$ docker run -d -v $(pwd):/opt/couchdb/data --name my-couchdb arm32v6/couchdb
```
...
```console
$ docker run --name my-couchdb -v /my/custom-config-dir:/opt/couchdb/etc/local.d -d arm32v6/couchdb
```
