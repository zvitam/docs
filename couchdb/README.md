...
```console
$ docker run -d -v $(pwd):/opt/couchdb/data --name my-couchdb ppc64le/couchdb
```
...
```console
$ docker run --name my-couchdb -v /my/custom-config-dir:/opt/couchdb/etc/local.d -d ppc64le/couchdb
```
